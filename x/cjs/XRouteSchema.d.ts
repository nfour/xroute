...
export declare class XRouteSchema<CONSTRUCTOR extends XRouteConstructor<any, any, any, any>, SCHEMA extends RouteSchema = RouteSchema> {
    config: CONSTRUCTOR;
    schema: SCHEMA;
    constructor(config: CONSTRUCTOR, schema: SCHEMA);
    readonly TYPE: {
...
export interface RouteSchema<PATH extends z.AnyZodObject = z.ZodObject<{}>, SEARCH extends z.AnyZodObject = z.ZodObject<{}>, HASH extends undefined | z.ZodType = undefined> {
    pathname: PATH;
    search: SEARCH;
